...
<div class="task_page1">
    <div class="container">
        <div class="col-md-8">
            <p>Устанавливает значение в поле Процент вознаграждения таблицы КОПИЯ_АГЕНТЫ равным значение1 для агентов, имеющих процент вознаграждения от значение2 до значение3 процентов. Значения задаются при выполнении запроса</p>
            <?php
            ...
            if(isset($_POST["btn_ok"])){
                ...
                $query_delete = "update 
                                    Copy_Insurance_Agents
                                set
                                    Copy_Insurance_Agents.agent_percent = '$new_procent'
                                where 
                                    Copy_Insurance_Agents.agent_percent between '$min' and '$max';";
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post">
                        <label>Процент вознаграждения от:</label>
                        <input type="number" class="form-control" name="min" required>
                        <label>Процент вознаграждения до:</label>
                        <input type="number" class="form-control" name="max" required>
                        <label>Процент вознаграждения новый:</label>
                        <input type="number" class="form-control" name="new_procent" required>
