...
<div class="task_page1">
    <div class="container">
        <div class="col-md-8">
            <p>Выбирает из таблицы АГЕНТЫ информацию о страховых агентах, процент вознаграждения для которых находится в диапазоне от значение1 до значение2. Значения задаются при выполнении запроса</p>
            <?php
            ...
            if(isset($_POST["btn_ok"])){
                ...
                $query = "select
                        ...
                        from
                            `Insurance_Agents`
                        where
                            agent_percent between $min and $max;";
