...
<div class="task_page1">
    <div class="container">
        <div class="col-md-12">
            <p>Выполняет группировку по полю Дата заключения договора. Для каждой группы вычисляет минимальное и максимальное значения по полю Сумма страхования</p>
            <?php
            ...
            $query = "select
                            ...
                            ,max(Contracts.insurance_amount) as 'max'
                            ,min(Contracts.insurance_amount) as 'min'
                        from
                            Contracts
            ...
            if($result) {
                ...
                echo "<table class='table table-striped'><tr><th>№</th><th>Дата</th><th>Максимальная Сумма страхования</th><th>Минимальная Сумма страхования</th></tr>";
