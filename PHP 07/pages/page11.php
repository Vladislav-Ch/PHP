...
<div class="task_page1">
    <div class="container">
        <div class="col-md-8">
            <p>Удаляет из таблицы КОПИЯ_АГЕНТЫ записи, в которых значение в поле Процент вознаграждения больше значения, заданного при выполнении запроса</p>
            <?php
            ...
            if(isset($_POST["btn_ok"])){
                ...
                $query_delete = "delete
                            from 
                                Copy_Insurance_Agents
                            where
                                Copy_Insurance_Agents.agent_percent > '$procent';";
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post">
                        ...
                        <input type="number" class="form-control" name="procent" required>
