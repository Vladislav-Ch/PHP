...
<div class="task_page1">
    <div class="container">
        <div class="col-md-8">
            <p>Выбирает из таблицы КЛИЕНТЫ информацию о клиентах с фамилией фамилия1, серия-номер паспорта которых начинается с цифр цифры1. Фамилия и цифры задаются при выполнении запроса</p>
            <?php
            ...
            $query = "select
                        id as '№'
                         ,concat(surname_customers, ' ', substring(name_customers,1,1), '.', substring(patronymic_customers,1,1), '.') as 'canc'
                         ,passport_ciustomers as 'pasp'
            ...
            if(isset($_POST["btn_ok"])){
                ...
                $query = "select
                    ...
                    from
                        Customers
                    where
                        surname_customers like '$surname'
                        and passport_ciustomers like '__ $passport%';";
        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post">
                        <label>Фамилия:</label>
                        <input type="text" class="form-control" name="surname_input" required>
                        <label>2 цифры паспорта</label>
                        <input type="number" class="form-control" name="passport_input" required>
